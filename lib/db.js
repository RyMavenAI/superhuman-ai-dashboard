...
const _upsertSession = db.prepare(`
  INSERT INTO sessions (session_id, session_file, started_at, model)
  VALUES (?, ?, ?, ?)
...
function upsertSession({ sessionId, sessionFile, startedAt, model }) {
  _upsertSession.run(sessionId, sessionFile, startedAt ?? null, model ?? null);
}
...
module.exports = { insertActivity, updateResult, upsertSession, getOffset, setOffset, getActivities, getSessions, getSessionActivities, getStats };
